          ...
          <div className="border-t border-gray-200 p-4">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-500 truncate">admin@theclubshop.com</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="hidden lg:flex items-center space-x-4">
              <h1 className="text-lg font-semibold text-gray-900">
                ...
                {pathname.startsWith('/admin/products/new') && 'Add Product'}
                {pathname.startsWith('/admin/clubs/new') && 'Add Club'}
                {!['/admin', '/admin/products', '/admin/clubs', '/admin/orders', '/admin/customers', '/admin/analytics', '/admin/settings', '/admin/profile'].includes(pathname) && 
                 !pathname.startsWith('/admin/products/new') && 
                 !pathname.startsWith('/admin/clubs/new') && 'Admin Panel'}
              </h1>
              <Link 
                href="/" 
            ...
            <div className="relative group">
              <button className="flex items-center space-x-2 p-2 rounded-lg hover:bg-gray-100">
                ...
                <div className="hidden sm:block text-left">
                  <span className="text-sm font-medium text-gray-700 block">Admin</span>
                  <span className="text-xs text-gray-500 block truncate max-w-32">
                    admin@theclubshop.com
                  </span>
                </div>
              ...
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <div className="py-1">
                  ...
                  <button 
                    onClick={() => alert('Sign out functionality disabled in demo mode')}
